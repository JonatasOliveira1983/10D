...
export const IconDashboard = ({ size = 24, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M3 3H10V10H3V3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14 3H21V7H14V3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14 11H21V21H14V11Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M3 14H10V21H3V14Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const IconOrganizer = ({ size = 24, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M22 19V9C22 7.89543 21.1046 7 20 7H12L10 4H4C2.89543 4 2 4.89543 2 6V19C2 20.1046 2.89543 21 4 21H20C21.1046 21 22 20.1046 22 19Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
export const IconHistory = ({ size = 24, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path d="M3.05 11C3.38612 8.79051 4.54284 6.78453 6.2737 5.4106C8.00456 4.03666 10.1989 3.38153 12.3846 3.58514C14.5704 3.78876 16.6025 4.83733 18.0463 6.50742C19.4901 8.1775 20.25 10.3585 20.1633 12.5833C20.0765 14.8082 19.1488 16.9271 17.5786 18.4864C16.0084 20.0456 13.9015 20.9443 11.7111 20.9897C9.52074 21.0351 7.39161 20.2241 5.78 18.73L3 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M3 11H8M3 11V16" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </svg>
);
...
export const IconLogout = ({ size = 24, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
...
export const IconGlobe = ({ size = 24, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path d="M2.06 12L21.94 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M12 2.06C14.5 4.5 16 8 16 12C16 16 14.5 19.5 12 21.94C9.5 19.5 8 16 8 12C8 8 9.5 4.5 12 2.06Z" stroke="currentColor" strokeWidth="2" />
    </svg>
);
...
export const IconPalette = ({ size = 24, className = "" }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path d="M6 12C6 12 7 11 8 11C9 11 10 12 10 12C10 12 11 13 12 13C13 13 14 12 14 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
